...
<body>
    ...
    <div id="main">
		<form method="post" action="php/updateProject.php" id="create"
			...
			<fieldset>
				...
				<p>
					<input type="hidden" value="<?php echo $projInfo['date'];?>"
						...
						name="projectId"> <label>Title: </label> <input type="text"
						name="title" class="required" id="title"
						value="<?php echo $projInfo['projectTitle'];?>" />
				</p>
        ...
        if (sizeof($con) > 0) {
            ...
            ?>
						...
						type="checkbox" id="moreC" onclick="addC()" />
    						    <?php
        } else {
            ?>
    						  <label>Any other contributors?</label> <input
						type="checkbox" id="moreC" onclick="addC()" />
    						  <?php
        }
        ...
        ?>
				...
				<div>
					<label>Logo Image (The main image or logo to be displayed with your
						...
						src='data:image/png;base64,<?php echo  base64_encode($projInfo['logoImage'])?>'
        ...
        $options = array(
            ...
            "Mobile Application",
            "Data Science",
            "Object Oriented Programs (Java, C# etc.)",
		...
		<form action="php/deleteProject.php" method="post" id="delete">
			...
			<button class="changeButton" onclick="deleteAccount(this)">Delete
				Project</button>
		</form>
	</div>
